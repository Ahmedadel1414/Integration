...
const FAQ = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "تقديم المطالبة أمر بسيط. يمكنك إما الاتصال بخط المطالبات لدينا المتاح على مدار 24/7، أو استخدام بوابة المطالبات عبر الإنترنت، أو زيارة أحد مكاتبنا. سيقوم فريق المطالبات المتخصص لدينا بإرشادك خلال العملية."
    },
    {
