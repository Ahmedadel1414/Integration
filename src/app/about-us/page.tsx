...
const page = () => {
  return (
    <section className="pb-10">
      <div className="relative -z-50 bg-[url(/assets/home-imgs/hero.jpg)] filter brightness-90 w-full bg-cover bg-fixed px-0 py-[150px]">
        <span>
          <h1 className="m-auto text-center text-4xl font-semibold pt-5 xs:text-5xl">
            الرؤية و الأهداف
          </h1>
          <p className="m-auto text-center text-2xl font-medium pt-10 xs:text-3xl">
